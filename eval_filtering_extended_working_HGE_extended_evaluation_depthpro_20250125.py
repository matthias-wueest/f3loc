...
if dataset == "gibson_t":
    ...
    if model == "gt":
        ...
        evol_path = "./evol_path/hge_customized_complete/depthpro_72" + "traj_len_" + str(traj_len) + "_dt_" + str(dt) + "_depthpro_epoch_last_50"
        #checkpoint_path = "./tb_logs/my_model/version_155/checkpoints/epoch=12-step=12415.ckpt"
        #checkpoint_path = "./tb_logs/my_model/version_155/checkpoints/epoch=49-step=47750.ckpt"
        ...
        #checkpoint_path = "./tb_logs/my_model/version_250/checkpoints/epoch=40-step=9799.ckpt" # depthpro
        checkpoint_path = "./tb_logs/my_model/version_250/checkpoints/last.ckpt" # depthpro
