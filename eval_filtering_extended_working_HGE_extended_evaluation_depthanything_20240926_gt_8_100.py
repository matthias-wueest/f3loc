...
dataset = "hge_customized_complete" # "hge_customized_cropped" # "hge_customized_complete" # 
model = "gt" # "depthanything" #"f3loc_own" # "metric3d_percentile_95" # "metric3d_attention" # 
# ckpt_path = "./logs"
dt = 8 #1 #2 #5 # 
