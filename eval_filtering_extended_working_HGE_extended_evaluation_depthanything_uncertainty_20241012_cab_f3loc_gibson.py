...
# ckpt_path = "./logs"
dt = 1 #2 #5 # 
traj_len = 50 #35 #20 #100 #25 # 
suffix = "_f3loc_trained_on_hge_20241113" #"_laplace_vitl_trained_hge_2seq" #"laplace_vitl_finetuned_on_cab_5epochs_2seq"#"_gt_on_cab_1seq" # "_with_scale"
