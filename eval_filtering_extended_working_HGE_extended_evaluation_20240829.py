...
model = "f3loc_own" # "gt" # "metric3d_percentile_95" # "metric3d_attention" # 
# ckpt_path = "./logs"
dt = 1 #2 #5 # 
traj_len = 100 #100 #50 #25 
...
if dataset == "gibson_t":
    ...
    if model == "gt":
        ...
        evol_path = "./evol_path/hge_customized_complete/gt_0" + str(int(desdf_resolution*10)) + "_" + str(orn_slice) + "_traj_len_" + str(traj_len) + "_dt_" + str(dt)
    elif model == "f3loc_own":
        #evol_path = "./evol_path/hge_customized_complete/f3loc_own"
        evol_path = "./evol_path/hge_customized_complete/f3loc_own_72" + "traj_len_" + str(traj_len) + "_dt_" + str(dt) + "_predicted_depths"
        checkpoint_path = "./tb_logs/my_model/version_60/checkpoints/epoch=19-step=19100.ckpt"
...
# 
# # Save file
# filename = "desdf_cropped_orn_slice_144_resolution_05_complete.npy"
