...
dataset_path = dataset_path = "/cluster/project/cvg/data/lamar/CAB_customized" #"/cluster/project/cvg/data/lamar/HGE_customized_complete" #"/cluster/project/cvg/data/lamar/HGE_customized_cropped"
...
# Define data
train_dataset = GridSeqDataset_hge_customized_cropped_gravity_align_depthanything(
    dataset_dir,
    split.train,
    L=L,
    depth_dir=depth_dir,
...
val_dataset = GridSeqDataset_hge_customized_cropped_gravity_align_depthanything(
    dataset_dir,
    split.val,
    L=L,
    depth_dir=depth_dir,
...
# # Define data
# train_dataset = GridSeqDataset_hge_customized_metric3d_offline( #GridSeqDataset_hge_customized_metric3d(
#     dataset_dir,
#     split.train,
#     L=L,
#     depth_dir=depth_dir,
...
# )
# 
# val_dataset =  GridSeqDataset_hge_customized_metric3d_offline( #GridSeqDataset_hge_customized_metric3d(
#     dataset_dir,
#     split.val,
#     L=L,
#     depth_dir=depth_dir,
...
#model = depth_net_metric3d_uncertainty_pl(shape_loss_weight=shape_loss_weight, lr=lr, d_min=d_min, d_max=d_max, d_hyp=d_hyp, D=D)
#model = depth_net_depthanything_pl(shape_loss_weight=shape_loss_weight, lr=lr, d_min=d_min, d_max=d_max, d_hyp=d_hyp, D=D)
model = depth_net_depthanything_uncertainty_pl(shape_loss_weight=shape_loss_weight, lr=lr, d_min=d_min, d_max=d_max, d_hyp=d_hyp, D=D)

###
## Load pre-trained model
#checkpoint_path = "./tb_logs/my_model/version_164/checkpoints/last.ckpt" # vitl
#lr = 1e-4
#model = depth_net_depthanything_uncertainty_pl.load_from_checkpoint(
