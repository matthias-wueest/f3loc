...
model = "gt" # "f3loc_own" # "metric3d_attention" # "metric3d_percentile_95" # 
uncertainty_bool = False
dt = 1 # 2 # 5 #
traj_len = 35#15# 15# 100#8#100#50
...
if dataset == "gibson_t":
    ...
    evol_path = "./evol_path/gibson_t/gt_"  + "traj_len_" + str(traj_len) + "_dt_" + str(dt) #evol_path = "./evol_path/gibson_f/mono"
...
#    )
    ...
    if ((model == "f3loc_own") or (model == "gt")):
