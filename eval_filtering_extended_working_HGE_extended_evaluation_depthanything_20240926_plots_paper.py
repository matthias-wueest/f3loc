...
model = "f3loc_own" # "gt" #"depthanything" #"metric3d_percentile_95" # "metric3d_attention" #  
# ckpt_path = "./logs"
dt = 1 #2 #5 # 
...
if dataset == "gibson_t":
    ...
    if model == "gt":
        ...
        evol_path = "./evol_path/hge_customized_complete/f3loc_own_72" + "traj_len_" + str(traj_len) + "_dt_" + str(dt) + "_plots_paper_L3_highres"
        checkpoint_path = "./tb_logs/my_model/version_60/checkpoints/epoch=19-step=19100.ckpt"
