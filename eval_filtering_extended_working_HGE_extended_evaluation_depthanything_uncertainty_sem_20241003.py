...
model = "depthanything_sem" #"depthanything" #"metric3d_attention" # "gt" # "f3loc_own" # "metric3d_percentile_95" # 
# ckpt_path = "./logs"
dt = 1 #2 #5 # 
...
if dataset == "gibson_t":
    ...
    if model == "gt":
        ...
        evol_path = "./evol_path/hge_customized_complete/depthanything_0" + str(int(desdf_resolution*10)) + "_" + str(orn_slice) + "_traj_len_" + str(traj_len) + "_dt_" + str(dt) + "_epoch49_T30"
...
#for data_idx in tqdm.tqdm(range(5,len(test_set))):
    ...
    for t in range(traj_l - L):
        ...
        if net_type == "d" or net_type == "comp_s":
            ...
            elif (model == "metric3d_percentile_95") or (model == "metric3d_attention") or (model == "depthanything") or (model == "depthanything_sem"):
                if ((dataset == "hge_customized_cropped") or (dataset =="hge_customized_complete")):
                    input_dict.update(
                        {
                            "img": imgs[:, t + L, :, :],
