...
suffix = "_laplace_teaser_paper_L3_highres" # "_with_scale"
...
#for data_idx in tqdm.tqdm(range(47,48)):
for data_idx in tqdm.tqdm(range(7, 8)):
    ...
    for t in range(10):
        ...
        if (evol_path is not None) & (log_extended==True):
            ...
            if ((dataset == "hge_customized_cropped") or (dataset =="hge_customized_complete")):
                ...
                #vmin = 0
                #vmax = 1
                #ax.imshow(likelihood_2d, cmap="coolwarm",vmin=vmin, vmax=vmax)
            else:
