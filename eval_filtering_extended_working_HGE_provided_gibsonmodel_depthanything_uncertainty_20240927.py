...
if dataset == "gibson_t":
    ...
    #evol_path = "./evol_path/gibson_t/depthanything_uncertainty_epoch13"
    evol_path = "./evol_path/gibson_t/depthanything_uncertainty_epoch19_paper_L0"
    ...
    evol_path = "./evol_path/hge_customized_complete/gt/gravity_align_L3"
    desdf_resolution = 0.1
    orn_slice = 36
...
#checkpoint_path = "./tb_logs/my_model/version_165/checkpoints/epoch=2-step=15633.ckpt"
#checkpoint_path = "./tb_logs/my_model/version_166/checkpoints/last.ckpt"
checkpoint_path = "./tb_logs/my_model/version_166/checkpoints/epoch=19-step=104220.ckpt"
#checkpoint_path = "./tb_logs/my_model/version_167/checkpoints/epoch=13-step=72954.ckpt"
#checkpoint_path = "./tb_logs/my_model/version_167/checkpoints/last.ckpt"

dt = 1 # 2 # 5 # 
traj_len = 100#15# 15# 100#8#100#50
...
#            )
        ...
        if (evol_path is not None) & (log_extended==TrajDataset_hge_customized_cropped):
