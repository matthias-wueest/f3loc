...
suffix = "_gaussian_last50" # "_laplace" # "_with_scale"
...
if dataset == "gibson_t":
    ...
    if model == "gt":
        ...
        #checkpoint_path = "./tb_logs/my_model/version_164/checkpoints/last.ckpt" # vitl
    ...
    if model == "gt":
        ...
        #checkpoint_path = "./tb_logs/my_model/version_206/checkpoints/last.ckpt" # vitb
        #checkpoint_path = "./tb_logs/my_model/version_206/checkpoints/epoch=10-step=10505.ckpt"# vitb
        checkpoint_path = "./tb_logs/my_model/version_252/checkpoints/last.ckpt" # vits gaussian
