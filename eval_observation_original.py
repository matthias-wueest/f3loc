...
def evaluate_observation():
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "comp",
            "comp_s",
        ],  # d: monocular, mvd: multi-view, comp: learned complementary, comp_s: hard threshold complementary
        help="type of the network to evaluate. d: monocular, mvd: multi-view, comp: learned complementary, comp_s: hard threshold complementary",
    )
    parser.add_argument(
        "--dataset",
        type=str,
