...
# ckpt_path = "./logs"
dt = 1 #2 #5 # 1
traj_len = 35 #100 #35 #20 #100 #25 # 
suffix = "_laplace" # "_with_scale"
...
if dataset == "gibson_t":
    ...
    if model == "gt":
        ...
        evol_path = "./evol_path/hge_customized_complete/dinov2_0" + str(int(desdf_resolution*10)) + "_" + str(orn_slice) + "_traj_len_" + str(traj_len) + "_dt_" + str(dt) + suffix
        #checkpoint_path = "./tb_logs/my_model/version_163/checkpoints/epoch=4-step=4775.ckpt"
        #checkpoint_path = "./tb_logs/my_model/version_164/checkpoints/epoch=4-step=4775.ckpt"
        #checkpoint_path = "./tb_logs/my_model/version_164/checkpoints/last.ckpt"
        #checkpoint_path = "./tb_logs/my_model/version_204/checkpoints/last.ckpt" # vits
        ...
        #checkpoint_path = "./tb_logs/my_model/version_206/checkpoints/last.ckpt" # vitb
        #checkpoint_path = "./tb_logs/my_model/version_206/checkpoints/epoch=10-step=10505.ckpt"# vitb
        checkpoint_path = "./tb_logs/my_model/version_265/checkpoints/epoch=44-step=10755.ckpt" # dinov2 vitl
