...
model = "f3loc_own" # "depthanything" #"gt" # "metric3d_attention" # "gt" # "metric3d_percentile_95" # 
# ckpt_path = "./logs"
dt = 1 #2 #5 # 
traj_len = 100#50 #35 #20 #100 #25 # 
suffix = "_f3loc_own_trained_hge_2seq" #"_laplace_vitl_trained_on_cab_2seq" #"_laplace_vitl_trained_hge_2seq" #"laplace_vitl_finetuned_on_cab_5epochs_2seq"#"_gt_on_cab_1seq" # "_with_scale"
