...
model = "depthanything" #"gt" # "metric3d_attention" # "gt" # "f3loc_own" # "metric3d_percentile_95" # 
# ckpt_path = "./logs"
dt = 1 #2 #5 # 
traj_len = 100 #50 #35 #20 #25 # 
suffix = "laplace_vitl_trained_on_cab"#"laplace_vitl_finetuned_on_cab_10epochs_1seq"#"laplace_vitl_finetuned_on_cab_5epochs_1seq"#"_laplace_vitl_trained_on_hge_20241113" #"_laplace_vitl_trained_hge_2seq" #"_gt_on_cab_1seq" # "_with_scale"
