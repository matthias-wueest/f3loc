...
dt = 1 # 2 # 5 # 
traj_len = 100#15 #20 #35 #50 #15# 15# 8#100#50
...
if dataset == "gibson_t":
    ...
    #evol_path = "./evol_path/gibson_t//depthanything_uncertainty_epoch13" #evol_path = "./evol_path/gibson_f/mono"
    #evol_path = "./evol_path/gibson_t//depthanything_uncertainty" + "traj_len_" + str(traj_len) + "_dt_" + str(dt)
    evol_path = "./evol_path/gibson_t//depthanything_uncertainty_vitb_" + "traj_len_" + str(traj_len) + "_dt_" + str(dt)
...
#checkpoint_path = "./tb_logs/my_model/version_167/checkpoints/epoch=48-step=72954.ckpt"
#checkpoint_path = "tb_logs/my_model/version_221/checkpoints/epoch=48-step=85113.ckpt" # vits
checkpoint_path = "tb_logs/my_model/version_223/checkpoints/epoch=48-step=85113.ckpt" # vitb
