...
#model = "metric3d_percentile_95" # "gt" # 
dataset = "hge_customized_complete" #"hge_customized_cropped" #  
model = "depthanything_sem_split" #"gt_sem" #"depthanything_sem_split" #"depthanything" #"metric3d_attention" # "gt" # "f3loc_own" # "metric3d_percentile_95" # 
# ckpt_path = "./logs"
dt = 1 #2 #5 # 
traj_len = 100#50 #35 #20 #100 #25 # 
suffix = "_laplace_sem_last" # "_laplace_epoch49" # "_with_scale"
...
if dataset == "gibson_t":
    ...
    desdf_resolution = 0.5#0.1
    orn_slice = 144#72#36
    if model == "gt":
        #evol_path = "./evol_path/hge_customized_complete/gt"
        evol_path = "./evol_path/hge_customized_complete/gt_72" + "traj_len_" + str(traj_len) + "_dt_" + str(dt) + suffix
    elif model == "f3loc_own":
        #evol_path = "./evol_path/hge_customized_complete/f3loc_own"
        evol_path = "./evol_path/hge_customized_complete/f3loc_own_72" + "traj_len_" + str(traj_len) + "_dt_" + str(dt) + suffix
        #checkpoint_path = "./tb_logs/my_model/version_60/checkpoints/epoch=19-step=19100.ckpt"
        checkpoint_path = "./tb_logs/my_model/version_124/checkpoints/epoch=19-step=19100.ckpt"

    elif model == "metric3d_percentile_95":
        #evol_path = "./evol_path/hge_customized_complete/metric3d_percentile_95"
        evol_path = "./evol_path/hge_customized_complete/metric3d_percentile_95_72" + "traj_len_" + str(traj_len) + "_dt_" + str(dt) + suffix
    elif model == "metric3d_attention":
        #evol_path = "./evol_path/hge_customized_complete/metric3d_attention"
        evol_path = "./evol_path/hge_customized_complete/metric3d_attention_72" + "traj_len_" + str(traj_len) + "_dt_" + str(dt) + suffix
        #checkpoint_path = "./tb_logs/my_model/version_89/checkpoints/epoch=19-step=9560.ckpt"
        #checkpoint_path = "./tb_logs/my_model/version_123/checkpoints/epoch=4-step=4775.ckpt"
        #checkpoint_path = "./tb_logs/my_model/version_123/checkpoints/epoch=5-step=5730.ckpt"
        #checkpoint_path = "./tb_logs/my_model/version_123/checkpoints/epoch=6-step=6685.ckpt"
        #checkpoint_path = "./tb_logs/my_model/version_123/checkpoints/epoch=8-step=8595.ckpt"
        #checkpoint_path = "./tb_logs/my_model/version_123/checkpoints/epoch=9-step=9550.ckpt"
        #checkpoint_path = "./tb_logs/my_model/version_123/checkpoints/epoch=13-step=13370.ckpt"
        #checkpoint_path = "./tb_logs/my_model/version_123/checkpoints/epoch=15-step=15280.ckpt"
        #checkpoint_path = "./tb_logs/my_model/version_123/checkpoints/epoch=16-step=16235.ckpt"
        #checkpoint_path = "./tb_logs/my_model/version_127/checkpoints/epoch=49-step=23900.ckpt"
        #checkpoint_path = "./tb_logs/my_model/version_127/checkpoints/epoch=19-step=9560.ckpt"
        checkpoint_path = "./tb_logs/my_model/version_130/checkpoints/epoch=49-step=47750.ckpt"

    elif model == "depthanything":
        #evol_path = "./evol_path/hge_customized_complete/depthanything_72" + "traj_len_" + str(traj_len) + "_dt_" + str(dt) + suffix
        evol_path = "./evol_path/hge_customized_complete/depthanything_0" + str(int(desdf_resolution*10)) + "_" + str(orn_slice) + "_traj_len_" + str(traj_len) + "_dt_" + str(dt)
        #checkpoint_path = "./tb_logs/my_model/version_163/checkpoints/epoch=4-step=4775.ckpt"
        checkpoint_path = "./tb_logs/my_model/version_164/checkpoints/last.ckpt"

    elif model == "depthanything_sem":
        evol_path = "./evol_path/hge_customized_complete/depthanything_0" + str(int(desdf_resolution*10)) + "_" + str(orn_slice) + "_traj_len_" + str(traj_len) + "_dt_" + str(dt)
        #checkpoint_path = "./tb_logs/my_model/version_185/checkpoints/epoch=5-step=5730.ckpt"
        checkpoint_path = "./tb_logs/my_model/version_185/checkpoints/last.ckpt"

    elif model == "depthanything_sem_split":
        evol_path = "./evol_path/hge_customized_complete/depthanything_sem_split_0" + str(int(desdf_resolution*10)) + "_" + str(orn_slice) + "_traj_len_" + str(traj_len) + "_dt_" + str(dt) + "_summation_uncertainty_last"
        checkpoint_path_depth = "./tb_logs/my_model/version_164/checkpoints/last.ckpt"
        #checkpoint_path_semantic = "./tb_logs/my_model/version_193/checkpoints/epoch=9-step=9550.ckpt"
        #checkpoint_path_semantic = "./tb_logs/my_model/version_194/checkpoints/epoch=9-step=9550.ckpt"
        checkpoint_path_semantic = "./tb_logs/my_model/version_195/checkpoints/last.ckpt"
        #checkpoint_path_semantic = "./tb_logs/my_model/version_195/checkpoints/epoch=5-step=5730.ckpt"
    
    elif model == "gt_sem":
        evol_path = "./evol_path/hge_customized_complete/gt_sem" + str(int(desdf_resolution*10)) + "_" + str(orn_slice) + "_traj_len_" + str(traj_len) + "_dt_" + str(dt)
...
if ((dataset == "hge_customized_cropped") or (dataset =="hge_customized_complete")):
    ...
    if (model == "gt")  or (model == "f3loc_own"):
        ...
        test_set = TrajDataset_hge_customized_metric3d_offline( #TrajDataset_hge_customized_metric3d(
            dataset_dir,
            split.test,
            L=traj_l,
            depth_dir=depth_dir,
        ...
        test_set = TrajDataset_hge_customized_cropped_gravity_align_depthanything(
            dataset_dir,
            split.test,
            L=traj_l,
            depth_dir=depth_dir,
    ...
    elif (model == "depthanything_sem") or (model == "depthanything_sem_split") or (model == "gt_sem"):
        semantic_dir = depth_dir
        semantic_suffix = "semantic90"
        test_set = TrajDataset_hge_customized_cropped_gravity_align_depthanything_semantics(
            dataset_dir,
            split.test,
            L=traj_l,
            depth_dir=depth_dir,
...
if (net_type == "d" or net_type == "comp_s"):
    ...
    if (model == "f3loc_own") or (model == "f3loc_provided"):
        ...
        d_net = depth_net_metric3d_uncertainty_pl.load_from_checkpoint(
            checkpoint_path=checkpoint_path,
            d_min=d_min,
            d_max=d_max,
            d_hyp=d_hyp,
        ...
        d_net = depth_net_depthanything_uncertainty_pl.load_from_checkpoint(
            checkpoint_path=checkpoint_path,
            d_min=d_min,
            d_max=d_max,
            d_hyp=d_hyp,
        ...
        temperature = 1 #1e8 #30 #100 #10 #1e3
        d_net = depth_net_depthanything_uncertainty_sem_pl.load_from_checkpoint(
            checkpoint_path=checkpoint_path,
            d_min=d_min,
            d_max=d_max,
            d_hyp=d_hyp,
        ...
        d_net = depth_net_depthanything_uncertainty_pl.load_from_checkpoint(
            checkpoint_path=checkpoint_path_depth,
            d_min=d_min,
            d_max=d_max,
            d_hyp=d_hyp,
            D=D,
        ...
        sem_net = semantic_net_depthanything_pl.load_from_checkpoint(
            checkpoint_path=checkpoint_path_semantic
        ).to(device)
...
# print("load desdf ...")
# desdf_path = "/cluster/home/wueestm/f3loc/"
# desdfs = {}
# #for scene in tqdm.tqdm(test_set.scene_names):
# #    desdfs[scene] = np.load(
# #        os.path.join(desdf_path, scene, "desdf_complete_orn_slice_144_resolution_05.npy"), allow_pickle=True
# #    )#.item()
# 
# desdf = np.load(
#     os.path.join(desdf_path, "desdf_complete_orn_slice_144_resolution_05.npy"), allow_pickle=True
# )#.item()
# 
# # Adapt file
# desdf_cropped = {}
...
# desdf_cropped["desdf"]=desdf
# 
# # Save file
# filename = "desdf_complete_orn_slice_144_resolution_05_adapted.npy"
# target_path_desdf = "/cluster/home/wueestm/f3loc/" #"/cluster/project/cvg/data/lamar/HGE_customized_complete/"
...
# 
# # get desdf for the scene
# print("load semantics desdf ...")
# desdfs_sem = {}
# #for scene in tqdm.tqdm(test_set.scene_names):
# #    desdfs_sem[scene] = np.load(
# #        os.path.join(desdf_path, scene, "desdf_sem_complete_orn_slice_144_resolution_05.npy"), allow_pickle=True
# #    )#.item()
# desdf_sem = np.load(
#     os.path.join(desdf_path, "desdf_sem_complete_orn_slice_144_resolution_05.npy"), allow_pickle=True
# )#.item()
# 
# # Adapt file
# desdf_sem_cropped = {}
# desdf_sem_cropped["l"]=int(0)
# desdf_sem_cropped["t"]=int(0)
# desdf_sem_cropped["desdf"]=desdf_sem
# 
# # Save file
# filename_sem = "desdf_sem_complete_orn_slice_144_resolution_05_adapted.npy"
# target_path_desdf_sem = "/cluster/home/wueestm/f3loc/"
# filename_sem = os.path.join(target_path_desdf_sem, filename_sem)
# np.save(filename_sem, desdf_sem_cropped)
# #####
...
# get desdf_semantics for the scene
print("load desdf_semantics ...")
desdfs_semantics = {}

if ((dataset == "hge_customized_cropped") or (dataset =="hge_customized_complete")):
    ### Improved i.t.o. memory
    scene = test_set.scene_names[0]
    desdfs_semantics["desdf"] = np.load(os.path.join(desdf_path, scene, "desdf_sem.npy"), allow_pickle=True).item()
else:
    print("Not available.")
...
# record stats
RMSEs = []
success_100 = []  # Success @ 10m
success_50 = []  # Success @ 5m
success_20 = []  # Success @ 2m
...
#for data_idx in tqdm.tqdm(range(5,len(test_set))):
    ...
    if ((dataset == "hge_customized_cropped") or (dataset =="hge_customized_complete")):
        desdf = desdfs["desdf"]
        desdf_sem =desdfs_semantics["desdf"]
    else:
        desdf = desdfs[scene]
        print("desdf_sem not implemented")
    ...
    if ((dataset == "hge_customized_cropped") or (dataset =="hge_customized_complete")):
        ...
        imgs_rgb = torch.tensor(data["imgs_rgb"], device=device)
        print("imgs_rgb.shape: ", imgs_rgb.shape)
    ...
    for t in range(traj_l - L):
        ...
        if net_type == "d" or net_type == "comp_s":
            ...
            elif (model == "metric3d_percentile_95") or (model == "metric3d_attention") or (model == "depthanything") or (model == "depthanything_sem") or (model == "depthanything_sem_split") or (model == "gt_sem"):
                if ((dataset == "hge_customized_cropped") or (dataset =="hge_customized_complete")):
                    input_dict.update(
                        {
                            "img": imgs[:, t + L, :, :],
        ...
        if net_type == "mvd" or (net_type == "comp_s" and use_mv):
            ...
            ### Semantics
                ...
                print("Trained model (Semantics)") # DB
                input_img_np = input_dict["img"].squeeze(0).detach().cpu().numpy()

                ### Trained model:
                loc, scale, attn, prob, sem_logits, sem_probs = d_net.encoder(
                    input_dict["img"], input_dict["mask"]
                )
                sem_probs = F.softmax(sem_logits/temperature, dim=-1)
                #loc, scale, attn, prob, class_logits, class_probs
                pred_depths = loc.squeeze(0).detach().cpu().numpy()
                pred_scales = scale.squeeze(0).detach().cpu().numpy()
                pred_semantics = sem_probs.squeeze(0).detach().cpu().numpy()
                ###                

            elif (model == "gt_sem"):
                pred_depths = np.array(data["gt_depth"])[t + L,:]
                pred_scales = np.full_like(pred_depths, 1e-8)
                pred_semantics = np.array(data["gt_semantic"])[t + L,:]
                # One-hot encode pred_semantics
                num_classes = 3  # 0, 1, 2 correspond to 3 classes
                pred_semantics = np.eye(num_classes)[pred_semantics]

                print("pred_depths.shape: ", pred_depths.shape)
                print("pred_scales.shape: ", pred_scales.shape)
                print("pred_semantics.shape: ", pred_semantics.shape)

            ### Semantics split
            elif (model == "depthanything_sem_split"):
                print("Trained model (Semantics split)") # DB
                input_img_np = input_dict["img"].squeeze(0).detach().cpu().numpy()
                ...
                ### Trained model semantic:
                temperature = 1#1e10
                sem_logits, sem_probs = sem_net.encoder(
                    input_dict["img"], input_dict["mask"]
                )
                sem_probs = F.softmax(sem_logits/temperature, dim=-1)
                pred_semantics = sem_probs.squeeze(0).detach().cpu().numpy()
        ...
        if ((dataset == "hge_customized_cropped") or (dataset =="hge_customized_complete")):
            ...
            # # Laplace
            # pred_rays, scales_rays = get_ray_from_depth_uncertainty(pred_depths, pred_scales, V=V, dv=dv, F_W=1596/1440)
            # pred_rays = torch.tensor(pred_rays, device=device)
            # scales_rays = torch.tensor(scales_rays, device=device)

            # Semantics
            pred_rays, scales_rays, semantics_rays = get_ray_from_depth_uncertainty_semantics(
                pred_depths, 
                pred_scales, 
                pred_semantics, 
                V=V, 
            ...
            pred_rays = torch.tensor(pred_rays, device=device)
            scales_rays = torch.tensor(scales_rays, device=device)
            semantics_rays = torch.tensor(semantics_rays, device=device)
        ...
        if ((dataset == "hge_customized_cropped") or (dataset =="hge_customized_complete")):
            ...
            ## Laplace
            #likelihood, likelihood_2d, likelihood_orn, likelihood_pred = localize_noflip_uncertainty(
            #    torch.tensor(desdf["desdf"]).to(prior.device),
            #    pred_rays.to(prior.device),
            ...
            # Semantics
            likelihood, likelihood_2d, likelihood_orn, likelihood_pred = localize_noflip_uncertainty_semantics(
                torch.tensor(desdf["desdf"]).to(prior.device),
                torch.tensor(desdf_sem["desdf"]).to(prior.device),
                pred_rays.to(prior.device),
                scales_rays.to(prior.device),
                semantics_rays.to(prior.device),
                return_np=False,
                orn_slice=orn_slice,
                lambd=40
            )
            ...
            ## Semantics
            #likelihood, likelihood_2d, likelihood_orn, likelihood_pred = localize_noflip_semantics(
            #    torch.tensor(desdf["desdf"]).to(prior.device),
            #    torch.tensor(desdf_sem["desdf"]).to(prior.device),
            #    pred_rays.to(prior.device),
            #    semantics_rays.to(prior.device),
        ...
        if (evol_path is not None) & (log_extended==True):
            ...
            ### Quality of semantic prediction: Predicted semantic vs. GT semantic
            # Get variables
            gt_semantics = np.array(data["gt_semantic"])[t + L,:]
            
            ## Top-1 accuracy
            # Get the index of the maximum predicted probability for each entry (i.e., the predicted class)
            predicted_classes = np.argmax(pred_semantics, axis=1)
            # Calculate accuracy by comparing predicted classes to ground truth
            metric_top1_acc = np.mean(predicted_classes == gt_semantics)
            print(f"Top-1 Accuracy: {metric_top1_acc:.4f}")

            ## Brier score
            # One-hot encode the ground truth labels
            gt_one_hot = np.zeros_like(pred_semantics)
            gt_one_hot[np.arange(len(gt_semantics)), gt_semantics] = 1
            # Calculate the Brier score (mean squared difference between predicted probabilities and one-hot labels)
            metric_brier_score = np.mean(np.sum((pred_semantics - gt_one_hot) ** 2, axis=1))
            print(f"Brier Score: {metric_brier_score:.4f}")
            ...
            metric_top1_acc_ls.append(metric_top1_acc)
            metric_brier_score_ls.append(metric_brier_score)
            metric_depth_shape_loss_ls.append(metric_depth_shape_loss)
            ...
            print("imgs_rgb.shape: ", imgs_rgb.shape)
            img_rgb_np = imgs_rgb[t + L, :, :, :].squeeze(0).detach().cpu().numpy()
            ax = fig.add_subplot(1, 7, 2)
            img = ax.imshow(img_rgb_np)
            ax.axis('off')
            ...
            ax.plot(gt_semantics, label="GT Semantics")
            ax.plot(pred_semantics, label="Predicted Semantics")
            ax.set_title("Top-1 Acc.: " + str(np.round(metric_top1_acc , 2)) + " / Brier: " + str(np.round(metric_brier_score,2)))
...
#            )
    ...
    if (evol_path is not None) and (log_extended==True):    
            fig = plt.figure(5, figsize=(2*6, 5*3))
            fig.clf()
            ...
            ax.set_title("Top-1 Accuracy [-]", fontsize=14)

            ax = fig.add_subplot(5, 2, 4)
            ax.plot(metric_brier_score_ls)
            ax.grid()
            ax.set_xlabel("Step [-]", fontsize=14)
            ...
            ax.set_title("Brier Score", fontsize=14)
    ...
    if log_error:
        ...
        if all(last_errors < 10):
            success_100.append(True)
            success_100_bool = True
        else:
            success_100.append(False)
            success_100_bool = False

        if all(last_errors < 5):
            success_50.append(True)
            success_50_bool = True
        else:
            success_50.append(False)
            success_50_bool = False

        if all(last_errors < 2):
            success_20.append(True)
            success_20_bool = True
        else:
            success_20.append(False)
            success_20_bool = False
        ...
        successes = [success_100_bool, success_50_bool, success_20_bool, success_10_bool, success_5_bool, success_3_bool, success_2_bool]
       
    if log_error:
        mean_depth_MAE_ls.append(np.mean(metric_depth_l1_loss_ls))
        mean_depth_cos_sim_ls.append(np.mean(metric_depth_shape_loss_ls))
        mean_top1_acc_ls.append(np.mean(metric_top1_acc_ls))
        mean_brier_score_ls.append(np.mean(metric_brier_score_ls))
...
if log_error:
    ...
    success_100 = np.array(success_100)
    success_50 = np.array(success_50)
    success_20 = np.array(success_20)    
    ...
    print("============================================")
    print("10.0 success rate : ", success_100.sum() / len(test_set))
    print("5.0 success rate : ", success_50.sum() / len(test_set))
    print("2.0 success rate : ", success_20.sum() / len(test_set))
...
if log_error:
    ...
    mean_mean_top1_acc = np.mean(mean_top1_acc_ls)
    mean_mean_brier_score = np.mean(mean_brier_score_ls)
    ...
    print("mean_mean_top1_acc : ", mean_mean_top1_acc)
    print("mean_mean_brier_score : ", mean_mean_brier_score)
...
if save_results:
    ...
    results_dict["overall"]["mean_mean_top1_acc"] = mean_mean_top1_acc
    results_dict["overall"]["mean_mean_brier_score"] = mean_mean_brier_score
