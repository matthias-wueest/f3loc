...
if __name__ == "__main__":
    floorplan_name = "map_CNB_G_cropped.png" #"map.png" #  "map_cropped.png" #
    floorplan = mpimg.imread(floorplan_name)
    pixel_per_meter = 41.915643239287924 #41.72119813062271 #18.315046895211292 41.915643239287924 
    occ = floorplan*255 # occ: the map as occupancy
    original_resolution = 1/pixel_per_meter
    resolution = 0.1#0.5#1
    orn_slice = 72 #144 #360 #144 #36
    max_dist = 50
    ...
    filepath = "/cluster/project/cvg/data/lamar/"
    filename = "desdf_complete_orn_slice_72_resolution_01_no_stairs.npy" #"desdf_complete_orn_slice_144_resolution_05_50_cropped_V2.npy" #"desdf_cnb_orn_slice_72_resolution_05.npy" # 
