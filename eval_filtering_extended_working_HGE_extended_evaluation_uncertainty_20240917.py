...
model = "f3loc_own" #"metric3d_attention" # "gt" # "f3loc_own" # "metric3d_percentile_95" # 
...
if dataset == "gibson_t":
    ...
    if model == "gt":
        ...
        evol_path = "./evol_path/hge_customized_complete/f3loc_own_laplace_72" + "traj_len_" + str(traj_len) + "_dt_" + str(dt) + suffix
        #checkpoint_path = "./tb_logs/my_model/version_60/checkpoints/epoch=19-step=19100.ckpt"
        ...
        checkpoint_path = "./tb_logs/my_model/version_156/checkpoints/epoch=99-step=95500.ckpt"
...
#for data_idx in tqdm.tqdm(range(5,len(test_set))):
    ...
    for t in range(traj_l - L):
        ...
        if net_type == "mvd" or (net_type == "comp_s" and use_mv):
            ...
            ### Trained model:
            elif (model == "f3loc_own") or (model == "metric3d_attention") or (model == "f3loc_provided"):
