...
dataset = "cab_customized" #"hge_customized_complete" #"hge_customized_cropped" #  
model = "gt" # "f3loc_own" #"f3loc_own" #"depthanything" #"metric3d_attention" # "gt" #  "metric3d_percentile_95" # 
# ckpt_path = "./logs"
dt = 1 #2 #5 # 
traj_len = 100 #50 #35 #20 #100 #25 # 
suffix = "_f3loc_trained_on_cab" #"_f3loc_trained_on_hge" #"_laplace_vitl_trained_hge_2seq" #"laplace_vitl_finetuned_on_cab_5epochs_2seq"#"_gt_on_cab_1seq" # "_with_scale"
...
elif (dataset =="hge_customized_complete") or (dataset =="cab_customized"):
    #dataset_path = "/cluster/project/cvg/data/lamar/HGE_customized_complete"
    dataset_path = "/cluster/project/cvg/data/lamar/CAB_customized"
    desdf_resolution = 0.1 #0.5#
    orn_slice = 72#144#36
    if model == "gt":
        ...
        evol_path = evol_path = "./evol_path/cab_customized/f3loc_0" + str(int(desdf_resolution*10)) + "_" + str(orn_slice) + "_traj_len_" + str(traj_len) + "_dt_" + str(dt) + suffix
        #checkpoint_path = "./tb_logs/my_model/version_60/checkpoints/epoch=19-step=19100.ckpt" # trained on hge
        #checkpoint_path = "./tb_logs/my_model/version_219/checkpoints/last.ckpt" # fine-tuned with 5 epochs
        #checkpoint_path = "./tb_logs/my_model/version_220/checkpoints/last.ckpt" # fine-tuned with 10 epochs
        checkpoint_path = "./tb_logs/my_model/version_221/checkpoints/last.ckpt" # trained on cab (last sequence)
        ...
        #evol_path = "./evol_path/hge_customized_complete/depthanything_0" + str(int(desdf_resolution*10)) + "_" + str(orn_slice) + "_traj_len_" + str(traj_len) + "_dt_" + str(dt) + suffix
        evol_path = "./evol_path/cab_customized/depthanything_0" + str(int(desdf_resolution*10)) + "_" + str(orn_slice) + "_traj_len_" + str(traj_len) + "_dt_" + str(dt) + suffix
        #checkpoint_path = "./tb_logs/my_model/version_163/checkpoints/epoch=4-step=4775.ckpt"
        #checkpoint_path = "./tb_logs/my_model/version_164/checkpoints/epoch=4-step=4775.ckpt"
        #checkpoint_path = "./tb_logs/my_model/version_164/checkpoints/last.ckpt" # vitl trained on hge
        #checkpoint_path = "./tb_logs/my_model/version_204/checkpoints/last.ckpt" # vits
        #checkpoint_path = "./tb_logs/my_model/version_204/checkpoints/epoch=6-step=6685.ckpt"# vits
        #checkpoint_path = "./tb_logs/my_model/version_206/checkpoints/last.ckpt" # vitb
        #checkpoint_path = "./tb_logs/my_model/version_206/checkpoints/epoch=10-step=10505.ckpt"# vitb
        #checkpoint_path = "./tb_logs/my_model/version_209/checkpoints/last.ckpt" # vitl
        #checkpoint_path = "./tb_logs/my_model/version_212/checkpoints/last.ckpt" # vitl fine-tuned (old)
        #checkpoint_path = "./tb_logs/my_model/version_213/checkpoints/last.ckpt" # vitl fine-tuned (old)

        #checkpoint_path = "./tb_logs/my_model/version_164/checkpoints/last.ckpt" # vitl trained on hge
        #checkpoint_path = "./tb_logs/my_model/version_214/checkpoints/last.ckpt" # vitl fine-tuned with 5 epochs
        #checkpoint_path = "./tb_logs/my_model/version_215/checkpoints/last.ckpt" # vitl fine-tuned with 10 epochs
        #checkpoint_path = "./tb_logs/my_model/version_216/checkpoints/last.ckpt" # vitl trained on cab (last sequence)

        # trained on gibson
        # checkpoint_path = "./tb_logs/my_model/version_166/checkpoints/epoch=19-step=104220.ckpt"
...
# depth file suffix
if (net_type == "d") & ((dataset == "hge_customized_cropped") or (dataset =="hge_customized_complete") or (dataset =="cab_customized")):
...
if ((dataset == "hge_customized_cropped") or (dataset =="hge_customized_complete") or (dataset =="cab_customized")):
...
# 
# # Save file
# filename = "desdf_orn_slice_72_resolution_01_50_cropped_no_stairs_adapted.npy"
# target_path_desdf = "/cluster/project/cvg/data/lamar/CAB_customized/"
...
elif dataset =="cab_customized":

    # Correspondences for calibration
    floorplan_correspondences = np.array([[1462, 730], 
                                      [1520, 2005], 
                                      [1635, 690], 
                                      [1720, 1435]])
    trajectory_correspondences = np.array([
        [-5.931726701805556, -28.735201771411326], 
        [1.0714430353505648, 1.3602896588811542], 
        [-10.171366453914183, -28.706392039122424], 
        [-7.147095608978532, -10.66452880520789]])
    #floorplan_correspondences = np.array([[1516, 490.5], [1532, 2162], [350, 1515], [391, 135]])
    #trajectory_correspondences = np.array([[-12.600, 10.103], [77.981, 9.882], [42.641, -54.348], [-33.099, -51.229]])
...
#for data_idx in tqdm.tqdm(range(5,len(test_set))):
    ...
    if ((dataset == "hge_customized_cropped") or (dataset =="hge_customized_complete") or (dataset =="cab_customized")):
        ...
        desdf = desdfs[scene]
    print("desdf[desdf].shape", desdf["desdf"].shape)
