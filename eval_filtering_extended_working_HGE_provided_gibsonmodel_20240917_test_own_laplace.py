...
model = "f3loc_own" # "metric3d_attention" # "gt" # "metric3d_percentile_95" # 
uncertainty_bool = True
dt = 1 # 2 # 5 #
traj_len = 100#35#15# 15# 8#100#50
...
if dataset == "gibson_t":
    ...
    #evol_path = "./evol_path/gibson_t/f3low_own_laplace_"  + "traj_len_" + str(traj_len) + "_dt_" + str(dt) #evol_path = "./evol_path/gibson_f/mono"
    evol_path = "./evol_path/gibson_t/paper_observation_likelihood_f3low_own_laplace_"  + "traj_len_" + str(traj_len) + "_dt_" + str(dt) #evol_path = "./evol_path/gibson_f/mono"
...
#checkpoint_path = "./f3loc_original/logs/mono_from_scratch_epoch=99.ckpt"
...
for data_idx in tqdm.tqdm(test_set_ls):
    ...
    for t in range(traj_l - L):
        ...
        if net_type == "d" or net_type == "comp_s":
            ...
            if (model == "metric3d_percentile_95") or (model == "metric3d_attention"):
                input_dict.update(
                            {
                                "img": imgs[:, t + L, :, :],
