...
model = "f3loc_own" # "gt" #"depthanything" #"f3loc_own" # "metric3d_percentile_95" # "metric3d_attention" #  
# ckpt_path = "./logs"
dt = 1 #2 #5 # 
traj_len = 20 #35 #20 x#25 
...
if dataset == "gibson_t":
    ...
    if model == "gt":
        ...
        evol_path = "./evol_path/hge_customized_cropped/f3loc_own_72" + "_traj_len_" + str(traj_len) + "_dt_" + str(dt)
    elif model == "metric3d_percentile_95":
