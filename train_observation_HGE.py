...
def train_observation():
    ...
    dataset = "hge_customized"
    dataset_path = "/cluster/scratch/wueestm/HGE_customized"
    ...
    roll = 0.001  # maximum roll augmentation in radian
    pitch = 0.001  # maximum pitch augmentation in radian
    ...
    if net_type == "d" and dataset == "hge_customized":
    ...
    # Define data
    train_dataset = GridSeqDataset_HGE(
        dataset_dir,
        split.train,
        L=L,
        depth_dir=depth_dir,
    ...
    val_dataset = GridSeqDataset_HGE(
        dataset_dir,
        split.val,
        L=L,
        depth_dir=depth_dir,
