...
# ckpt_path = "./logs"
dt = 1 #2 #5 # 
traj_len = 100#20 #50 #35 #20 #25 # 
suffix = "_laplace_depthpro_epoch_last_50" #"_laplace_depthpro_epoch_best" #"_laplace_depthpro_epoch15" # "_with_scale"
...
if dataset == "gibson_t":
    ...
    if model == "gt":
        ...
        #checkpoint_path = "./tb_logs/my_model/version_206/checkpoints/last.ckpt" # vitb
        #checkpoint_path = "./tb_logs/my_model/version_206/checkpoints/epoch=10-step=10505.ckpt"# vitb
        #checkpoint_path = "./tb_logs/my_model/version_245/checkpoints/epoch=8-step=4302.ckpt" # depthpro epoch08
        #checkpoint_path = "./tb_logs/my_model/version_245/checkpoints/epoch=15-step=7648.ckpt" # depthpro epoch15
        #checkpoint_path = "./tb_logs/my_model/version_249/checkpoints/epoch=38-step=9321.ckpt" # depthpro epoch38
        checkpoint_path = "./tb_logs/my_model/version_249/checkpoints/last.ckpt" # depthpro epoch50
...
#            without_depth=False, #without_depth=True,  
#        )
        test_set = TrajDataset_hge_customized_cropped_gravity_align_depthpro(
            dataset_dir,
            split.test,
            L=traj_l,
            depth_dir=depth_dir,
...
#for data_idx in tqdm.tqdm(range(10)):
